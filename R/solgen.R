...
#'
#'
#' @param x Either a positive integer greater than one, a data frame, or a
#'   configTable object, to be passed to \code{randomDat}. Determines the number,
#'   names, and type (crisp-set, multi-value or fuzzy) of the factors
#'   in the data set used for the analyses, and consequently the type of the
#'   solutions that are generated. If \code{class(x) == "integer"}, \code{full.ct(x)}
#'   is used.
#'
...
#'
#' @details First a data set is generated by \code{randomDat(x)}. This data is
#'   then repeatedly analyzed with \code{cna}, using every logically possible
#'   combination of consistency and coverage thresholds determined by arguments
#'   \code{range} and \code{gran}. Primary use-case is to quickly generate a
#'   throwaway set of solutions used as input to other functions that exploit
#'   the presence of submodel-relations to asses correctness, robustness,
#'   completeness etc. Checks the arguments given in \code{...}, only valid
#'   arguments are passed further, i.e. will not break if given unused
#'   arguments.
