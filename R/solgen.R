...
#'
#' @returns A vector or data.frame of CNA solutions with extra attribute
...
#'   producing a number of solutions fitted to the same underlying data, that
#'   can be easily compared to the structure that generated the data. First a
...
#'   configTable, the procedure is identical to crisp set data. The only
